<header id="header">
    <div class="container" style="margin-top: 33px ">
        <div class="row">
            <div class="col-md-10">
                <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Contornos </h1>
            </div>            
        </div>
    </div>
</header>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="exampleModalLabel">Registrar Nuevo Contorno</h4>
                        </div>
...
<script>
            ...
            $("#guardarDatos").submit(function (event) {
                ...
                $.ajax({
                    type: "POST",
                    url: "control/ctrl_contorno.php?caso=1",
                    data: parametros,
                    beforeSend: function () {
            ...
            $("#actualidarDatos").submit(function (event) {
                ...
                $.ajax({
                    type: "POST",
                    url: "control/ctrl_contorno.php?caso=2",
                    data: parametros,
                    beforeSend: function () {
